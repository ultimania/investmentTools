# Generated by Django 2.1.2 on 2019-07-20 02:26
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('bland_cd', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='mytrade.T_BLAND_MS')),
            ],
        ),
        migrations.CreateModel(
            name='T_TRG_PRM_MS',
        ...
        migrations.AddField(
            ...
            name='condition_no',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='mytrade.T_EXT_CND_TR'),
        ),
        migrations.AddField(
            model_name='t_ext_cnd_ch_tr',
            name='conditions',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='mytrade.T_CONDITIONS_MS'),
        ),
        migrations.AddField(
            model_name='t_ext_cnd_ch_tr',
            name='target0',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='mytrade.T_TRG_PRM_MS'),
        ),
        migrations.AddField(
            model_name='t_ext_cnd_ch_tr',
            name='target1',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='mytrade.T_STATISTIC_MS'),
        ),
        migrations.AddField(
            model_name='t_ext_cnd_ch_tr',
            name='unit',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='mytrade.T_UNIT_MS'),
        ),
        migrations.AddField(
            model_name='t_bland_ms',
            name='industry_cd',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='mytrade.T_INDUSTRY_MS'),
        ),
        migrations.AddField(
            model_name='t_bland_ms',
            name='scale_cd',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='mytrade.T_SCALE_MS'),
        ),
    ]
